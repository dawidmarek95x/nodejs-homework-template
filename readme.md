...
## General info
Server with implemented REST API to manage a set of contacts contained in the MongoDB database.
...
## Requirements
Create a server based on the REST API methodology that allows you to manage contacts stored in the [MongoDB](https://www.mongodb.com/) database. Use [Mongoose](https://mongoosejs.com/) to work with the database, use [Postman](https://www.postman.com/) or [Insomnia](https://insomnia.rest/) to work with the REST API and the [joi](https://github.com/hapijs/joi) package for additional validation.
