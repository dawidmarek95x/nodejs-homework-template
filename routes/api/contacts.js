...
router.post(
  "/",
  authMiddleware,
  validation.creatingContact,
  contactsController.addOne
);
...
router.put(
  "/:contactId",
  validation.updatingContact,
  contactsController.changeData
);

router.patch(
  "/:contactId/favorite",
  validation.updatingContactStatus,
  contactsController.changeValueOfFavorite
);
